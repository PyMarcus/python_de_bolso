...
class LoopsActivity : AppCompatActivity(), OnClickListener {

    private lateinit var binding: ActivityLoopsBinding
    private lateinit var profileController: LearnPercentController

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        this.binding = ActivityLoopsBinding.inflate(layoutInflater)
