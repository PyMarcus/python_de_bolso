...
class StructuresActivity : AppCompatActivity(), OnClickListener {
    private lateinit var binding: ActivityStructuresBinding
    private lateinit var profileController: LearnPercentController


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        this.binding = ActivityStructuresBinding.inflate(layoutInflater)
